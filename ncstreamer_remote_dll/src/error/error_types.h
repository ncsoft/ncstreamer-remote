...
#ifndef NCSTREAMER_REMOTE_DLL_SRC_ERROR_ERROR_TYPES_H_
#define NCSTREAMER_REMOTE_DLL_SRC_ERROR_ERROR_TYPES_H_
...
#endif  // NCSTREAMER_REMOTE_DLL_SRC_ERROR_ERROR_TYPES_H_
